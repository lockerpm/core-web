...
export class EventService implements EventServiceAbstraction {
  ...
  async collect(
    ...
    let eventCollection = await this.storageService.get<EventData[]>(
      ConstantsService.eventCollectionKey
    )
  ...
  async uploadEvents(): Promise<any> {
    ...
    const eventCollection = await this.storageService.get<EventData[]>(
      ConstantsService.eventCollectionKey
    )
